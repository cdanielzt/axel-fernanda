...
window.copyAccountNumber = function() {
  navigator.clipboard.writeText('4027660009042807').then(() => {
    ...
    alert('Número de cuenta: 4027660009042807');
  });
};

// Cuenta Regresiva
document.addEventListener('DOMContentLoaded', () => {
  // Fecha del evento: 10 de enero de 2026 a las 3:00 PM
  const weddingDate = new Date('January 10, 2026 15:00:00').getTime();
